...
import static com.danhtran12797.thd.app_music_test.Activity.LoadActivity.ANIM_ITEM_DURATION;
import static com.danhtran12797.thd.app_music_test.Activity.LoadActivity.STARTUP_DELAY;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    private void animate() {
        ...
        ViewCompat.animate(logoImageView)
                ...
                .scaleX(0.6f)
                .scaleY(0.6f)
                .setStartDelay(LoadActivity.STARTUP_DELAY)
                .setDuration(LoadActivity.ANIM_ITEM_DURATION).setInterpolator(
        ...
        ViewCompat.animate(container)
                ...
                .setStartDelay(LoadActivity.STARTUP_DELAY * 2)
                .setDuration(500)
